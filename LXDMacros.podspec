...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
TODO: Add long descriptiong of the pod here.
                   DESC

  s.homepage     = "https://github.com/sindrilin/LXDMacros"
  ...
  s.source       = { :git => "https://github.com/sindrilin/LXDMacros.git", :tag => "#{s.version}" }
  ...
  s.public_header_files = "LXDMacros/Classes/**/*.h"
